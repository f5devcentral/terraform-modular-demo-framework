...
terragrunt run-all apply --terragrunt-modules-that-include ./env-setup.hcl -auto-approve
terragrunt run-all apply --terragrunt-modules-that-include ./gitops-lab.hcl -auto-approve
