...
locals {
    ...
    azure_cloud_credential_name = var.volterra_cloud_cred_azure
    env_config = {
...
resource local_file envconfig {
  filename = "/home/ubuntu/expensive.food/envconfig.demo.yaml"
  content = templatefile("/home/ubuntu/expensive.food/ef.input.demo.template.yaml",{
    ...
    sshpublickey = file(var.ssh_public_key)
  ...
  provisioner "local-exec" {
    command = "sops -e /home/ubuntu/expensive.food/envconfig.demo.yaml > /home/ubuntu/expensive.food/ef.input.demo.yaml"
  }
}
